...
- You MUST use context7 MCP server to retrieve documentation, code examples, and library references for all research activities relating to code and libraries. Do NOT rely on internal knowledge or other sources unless context7 is unavailable.
